...
static ssize_t dht11_drv_read (struct file *file, char __user *buf, size_t size, loff_t *offset)
{
	...
	err = request_irq(irq, dht11_isr, IRQF_TRIGGER_FALLING|IRQF_TRIGGER_RISING, "WWJ_DHT11", NULL);
...
static const struct of_device_id wwj_dht11[] = {
    { .compatible = "wwj,dht11" },
    { },
};
